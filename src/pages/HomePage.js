      ...
      <div className="relative z-20">
        <div className="container mx-auto px-4 py-16">
          <nav className="flex justify-between items-center mb-16">
            <h1 className="text-3xl font-bold text-white">BadmintonSafe</h1>
            <div className="space-x-4">
              <Link
                to="/login"
                className="px-6 py-2 text-white bg-transparent border-2 border-white rounded-lg hover:bg-white hover:text-blue-900 transition-colors"
              >
                Login
              </Link>
              <Link
                to="/register"
                className="px-6 py-2 text-blue-900 bg-white rounded-lg hover:bg-blue-100 transition-colors"
              >
                Sign Up
              </Link>
            </div>
            ...
            <div className="text-white">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="p-2 bg-blue-800/50 backdrop-blur-sm rounded-lg mr-4">
                    <svg className="w-6 h-6 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg">Real-time Movement Analysis</h3>
                    <p className="text-blue-200">Get instant feedback on your technique and posture</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="p-2 bg-blue-800/50 backdrop-blur-sm rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">Advanced risk assessment and early warning system</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="p-2 bg-blue-800/50 backdrop-blur-sm rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">Monitor your progress and improve consistently</p>
                  </div>
                </div>
              </div>
            </div>
